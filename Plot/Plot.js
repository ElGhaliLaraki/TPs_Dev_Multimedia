class Plot {
    ...
    constructor(svg){
        ...
        this.svg = svg;
        this.dataset = {
            labels: ["Java", "JavaScript", "Ruby", "Python"],
            data: [20, 15, 10, 5],
        };
    ...
    prepareSvg() {
        ...
        for(let i=labels.length-1, x=svgX+svgWidth-5-xAxisW, y=svgY+svgHeight-30/2; i >= 0; --i) {
            ...
            const labelText = this.createTextFromLabel(labels[i], x+20, y-3, 'black');
        ...
        for(let i=0, m=min, x=svgX+svgWidth-5, y=svgY+svgHeight-30/2; i <= yAxisScale; ++i) {
            ...
            const labelText = this.createTextFromLabel(m.toString(), x-svgWidth+10, y-10, 'black');
            this.svg.appendChild(labelText);
            m += res_bound;
        ...
        for(let i=labels.length-1, x=svgX+svgWidth-5-xAxisW, y=svgY+svgHeight-30/2; i >= 0; --i) {
            ...
            rect.setAttributeNS(null, 'width', xAxisW-1*5);
